...
/**
 * Provides a plugin for the 'schema_medical_business_telephone' meta tag.
 *
 ...
 *
 * @MetatagTag(
 *   id = "schema_medical_business_telephone",
 ...
 * )
 */
class SchemaMedicalBusinessTelephone extends SchemaNameBase {
