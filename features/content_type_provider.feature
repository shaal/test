...
Feature: Location Content Type
  ...
  Scenario: Verify that migrated provider fields are read only
    ...
    Then I should not see the text "Last Name"
    Then I should not see the text "Location"
    Then I should not see the text "Medical Specialties"
    Then I should not see the text "Middle Name"
    Then I should not see the text "NPI ID"
    Then I should not see the text "Open Scheduling Available"
